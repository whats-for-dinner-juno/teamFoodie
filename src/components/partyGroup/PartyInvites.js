...
class PartyInvites extends Component {
    ...
    assignIngredient = (e, ingredient) => {
        ...
        let tempArray = this.state.bigArray;
        let index = tempArray.findIndex(x => x.guest === this.state.selectedGuest);
    ...
    returnIngredient = (e, ingredient, guest) => {
        ...
        let ingToDelete = tempBigArray[index].ingredients.findIndex(x => x.guest === guest)
            ...
            <Fragment>
                ...
                <div className="flexGrid">
                    ...
                    <div className="listOfGuests dashboardInfo">
                        ...
                        <form>
                        <label className="visuallyHidden">Please Select a Guest To Add Ingredients To Their Cart</label>
                        ...
                        <div className="listOfIngredients dashboardInfo">
                            {this.state.unassignedIngredients.map(
                                (ingredient) => {
                                    return (
                                        <button onClick={(e)=>{this.assignIngredient(
                                            e, ingredient
                                              )
               ...
               { this.state.bigArray.map((guest) => {
                ...
                <div>{guest.guest}
                    ...
                    {guest.ingredients.map((ing) => {
                            return( <button onClick={(e)=>{this.returnIngredient(
                            e, ing, guest.guest
                                )
